      ...
      <div className="bg-green-50 py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl font-extrabold text-gray-800 mb-6 tracking-tight leading-tight">
            Con <span className="text-blue-600">SSTGames</span>, aprende y minimiza 
            <span className="bg-gradient-to-r from-orange-500 to-pink-500 text-transparent bg-clip-text"> riesgos laborales </span> 
            jugando
          </h2>
